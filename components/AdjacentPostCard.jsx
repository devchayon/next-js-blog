...
const AdjacentPostCard = ({ post, position }) => (
  <>
    ...
    {position === 'LEFT' && (
      <div className="absolute arrow-btn bottom-5 text-center p-3 cursor-pointer bg-pink-600 left-4 rounded-full">
        <svg
    ...
    {position === 'RIGHT' && (
      <div className="absolute arrow-btn bottom-5 text-center p-3 cursor-pointer bg-pink-600 right-4 rounded-full">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-6 text-white w-full"
          fill="none"
